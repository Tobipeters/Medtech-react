...
const Footer = () =>{
    return (
        ...
        <div className="container px-4  pt-5">
            <h3 className="section-title">Contact <span className="fw-700">Us</span></h3>
            <div className="row">
                ...
                <div className="col-md-6">
                    <div className="row contact-details pt-5 pt-md-0">
                        <div className="col-lg-6 mb-3 mb-md-4">
                            <i className="me-2 text_blue" data-feather="mail"></i>
                            <span className="text-light">info@medtechng.com</span>
                        </div>
                        <div className="col-lg-6 mb-3 mb-md-4">
                            <i className="me-2 text_blue" data-feather="phone"></i>
                            <span className="text-light">+234 80 9362 5555</span>
                        </div>
                        <div className="col-lg-6 mb-3">
                            <i className="me-2 text_blue" data-feather="facebook"></i>
                            <span className="text-light">Medtech</span>
                        </div>
                        <div className="col-lg-6 mb-3">
                            <i className="me-2 text_blue" data-feather="twitter"></i>
                            <span className="text-light">Medtech</span>
                        </div>
                    </div>
                </div>
        ...
        <div className="border-top text-center py-3 px-3 text-light mt-5 mx-n3 copy_right">
            <small> <i>© 2020 – 2022 MedTech Professional Services, carebox and affiliates </i></small>
        </div>
    </section>
    )
}
